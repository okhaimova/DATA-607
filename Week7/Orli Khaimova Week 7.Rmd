...
Note: I had to remove row names and also replace a string of characters as one author has a German letter in their name. However, if there is unicode data in the file, you can
just include `encoding = "UTF-8"` when loading data. I also trasposed the data frame.
